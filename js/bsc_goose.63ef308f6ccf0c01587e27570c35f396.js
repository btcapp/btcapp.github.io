...
async function main() {  
   ...
   const rewardsPerWeek = await GOOSE_CHEF.eggPerBlock() /1e18
    ...
    await loadBscChefContract(App, tokens, prices, GOOSE_CHEF, GOOSE_CHEF_ADDR, GOOSE_CHEF_ABI, rewardTokenTicker,
