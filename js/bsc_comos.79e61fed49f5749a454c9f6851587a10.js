...
async function main() {  
   ...
   const CHEF_ADDR = "0xB02713560be2a7fb07B7B16Fd75F35d3632FC933";
   ...
   const rewardsPerWeek = await CHEF.comosPerBlock() /1e18
    ...
    await loadBscChefContract(App, tokens, prices, CHEF, CHEF_ADDR, CHEF_ABI, rewardTokenTicker,
        "comos", null, rewardsPerWeek, "pendingEgg", [1]); // Yes it's called "pendingEgg"
