...
async function main() {  
   ...
   const TASTE_CHEF_ADDR = "0x9b47E796a868135B4B26c013E32BAD3876F4e43c";
   const rewardTokenTicker = "TASTE";
   const TASTE_CHEF = new ethers.Contract(TASTE_CHEF_ADDR, TASTE_CHEF_ABI, App.provider);

   const rewardsPerWeek = await TASTE_CHEF.vikingPerBlock() /1e18
        * 604800 / 3;

    const tokens = {};
    const prices = await getBscPrices();

    await loadBscChefContract(App, tokens, prices, TASTE_CHEF, TASTE_CHEF_ADDR, TASTE_CHEF_ABI, rewardTokenTicker,
